...
public abstract class BlazorViewModelBase : IBlazorViewModelBase, INotifyPropertyChanged
{
    public bool IsBusy { get; set; }
    public IBlazorViewInvokeAsync? BlazorComponentInvokeAsync { get; set; }
    ...
    public virtual Task OnNavigatedToAsync(IParameters? parameters = null) => Task.CompletedTask;

    public virtual Task OnNavigatedFromAsync(IParameters? parameters = null) => Task.CompletedTask;
