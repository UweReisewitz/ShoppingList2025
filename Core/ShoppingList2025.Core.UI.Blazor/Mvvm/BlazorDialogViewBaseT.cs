...
public abstract class BlazorDialogViewBase<T, U> : BlazorViewBase<T>, IDisposable
    where T : IBlazorDialogViewModelBase<U>
{
    [CascadingParameter]
    ...
    protected override void OnInitialized()
    {
        ...
        this.ViewModel.Parameter = this.Parameter;
